jQuery().ready(function($) {
    ...
    var fields=["userid","variable","value","key","achievementid","level",
                ...
                "achievement_name","achievement_valid_start","achievement_valid_end",
                "achievement_lat","achievement_lng","achievement_max_distance","achievement_evaluation",
                "achievement_relevance","achievement_maxlevel","achievement_view_permission"];
    ...
    var api_funcs = {
        ...
        "add_Achivement" : {
            "fields":["achievement_name","achievement_valid_start","achievement_valid_end",
                      "achievement_lat","achievement_lng","achievement_max_distance","achievement_evaluation",
                      "achievement_relevance","achievement_maxlevel","achievement_view_permission"],
            "url":"/add_Achivement",
            "method":"POST"
